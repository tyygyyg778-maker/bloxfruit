	...
	Themes = {
		Darker = {
			["Color Hub 1"] = ColorSequence.new({
				...
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(20, 35, 45)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(15, 25, 35))
			}),
			["Color Hub 2"] = Color3.fromRGB(20, 30, 40),
			["Color Stroke"] = Color3.fromRGB(30, 60, 80),
			["Color Theme"] = Color3.fromRGB(0, 255, 255), -- ĐÃ SỬA THÀNH XANH BIỂN
		...
		Purple = {
			["Color Hub 1"] = ColorSequence.new({
				...
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(15, 45, 60)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(10, 30, 40))
			}),
			["Color Hub 2"] = Color3.fromRGB(15, 35, 50),
			["Color Stroke"] = Color3.fromRGB(0, 200, 200),
			["Color Theme"] = Color3.fromRGB(0, 255, 255), -- ĐÃ SỬA THÀNH XANH BIỂN
			["Color Text"] = Color3.fromRGB(243, 243, 243),
			["Color Dark Text"] = Color3.fromRGB(180, 180, 180)
		}
